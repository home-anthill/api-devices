...
const (
	KeepAlive_GetKeepAlive_FullMethodName = "/keepalive.KeepAlive/GetKeepAlive"
)
...
func (c *keepAliveClient) GetKeepAlive(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeepAlive_GetKeepAlive_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeepAlive_GetKeepAlive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeepAlive_GetKeepAlive_FullMethodName,
	}
